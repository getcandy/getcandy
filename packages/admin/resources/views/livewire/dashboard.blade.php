    ...
    <div class="space-y-4 lg:space-y-8">
        <div class="grid grid-cols-2 gap-4 sm:grid-cols-4 sm:gap-8">
          ...
          <div>
            ...
            <article class="p-6 bg-white rounded-lg shadow-sm">
        ...
        <div class="grid grid-cols-1 gap-4 lg:gap-8 lg:grid-cols-3">
            <div class="lg:col-span-2">
                ...
                <div class="p-6 mt-4 bg-white rounded-lg shadow-sm sm:p-8">
                    <div class="h-96">
            ...
            <div class="lg:col-span-2">
                <div class="flex items-center justify-between">
                    ...
                    <a href="{{ route('hub.orders.index') }}"
                       class="inline-flex items-center gap-2 px-4 py-2 text-gray-900 bg-white border border-gray-100 rounded-md">
                            ...
                            @foreach ($this->topSellingProducts as $product)
                                <li class="flex items-center gap-4 py-4">
                                    <a href="{{ route('hub.products.show', $product->purchasable->product->id) }}"
                                       class="grid w-16 h-16 border border-gray-100 rounded-md shrink-0">
