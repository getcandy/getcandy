<div>
    <button type="button" class="inline-flex items-center px-4 py-2 font-bold transition border border-transparent border-gray-200 rounded hover:bg-white bg-gray-50 hover:border-gray-200" theme="gray" size="sm" type="button" wire:click.prevent="$set('showStatusSelect', true)">
        Update Status
    </button>
